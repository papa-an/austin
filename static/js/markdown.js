...
function initMermaid() {
  if (!window.mermaid || window.__austinMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__austinMermaidReady = true;
}
window.austinInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'austin-thinking-expanded';
