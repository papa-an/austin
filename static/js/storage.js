...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'austin-model-expanded',
  MODEL_ENDPOINTS: 'austin-model-endpoints',
  MODEL_SELECTED: 'austin-selected-model',
  SORT_ORDER: 'austin-sessions-sort',
  CHAT_SEARCH_SCOPE: 'austin-search-scope',
  INCOGNITO: 'austin-incognito',
  RAG_ACTIVE: 'austin-rag-active',
  MCP_ACTIVE: 'austin-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'austin-density',
  WORKSPACE: 'austin-workspace'
};
