...
const LS_KEY = 'austin-theme';
const CUSTOM_THEMES_KEY = 'austin-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Austin Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'austin_' + (obj.name || 'theme') + '.json';
      a.click();
