...
COPILOT_USER_AGENT = os.environ.get(
    "AUSTIN_COPILOT_USER_AGENT", "Austin/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "AUSTIN_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "AUSTIN_COPILOT_EDITOR_VERSION", "Austin/1.0"
)
