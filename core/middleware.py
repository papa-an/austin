...
INTERNAL_TOOL_TOKEN = os.environ.get("AUSTIN_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Austin-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Austin-Internal-Token), or
