"""scripts/_lib/cli.py — shared scaffolding for the `austin-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("austin-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/austin-foo`
...
VERSION = "0.1.0"  # bumped centrally; every austin-* CLI reports this
